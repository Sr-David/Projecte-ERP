...
@section('breadcrumb')
    ...
    <li class="text-sm font-medium text-gray-900 pl-2">Clientes</li>
@endsection
        ...
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            ...
            <div class="flex flex-col sm:flex-row gap-3">
                ...
                <a 
                    ...
                    class="inline-flex items-center justify-center px-4 py-2 text-sm font-medium text-white bg-brand-blue rounded-lg hover:bg-blue-700 focus:ring-4 focus:ring-blue-300"
                >
                        ...
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-blue-100 text-blue-800">
                                    {{ $client->clientType->ClientType ?? 'Sin asignar' }}
                                </span>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                <div class="flex items-center space-x-3">
                                    ...
                                    <form action="{{ route('clients.destroy', $client) }}" method="POST" class="inline" onsubmit="return confirm('¿Está seguro que desea eliminar este cliente?');">
                                        @csrf
                                        @method('DELETE')
                    ...
                    @empty
                        <tr>
                            <td colspan="5" class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 text-center">
                                No hay clientes registrados. <a href="{{ route('clients.create') }}" class="text-blue-600 hover:underline">Registrar nuevo cliente</a>
                            </td>
                        </tr>
                    @endforelse
                </tbody>
...
@section('scripts')
<script>
    // Aquí pueden ir scripts específicos para la gestión de clientes
</script>
@endsection 