...
@section('breadcrumb', 'Leads / Crear')
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <select name="Source" id="Source" required
                            ...
                            <option value="Social Media" {{ old('Source') == 'Social Media' ? 'selected' : '' }}>Redes Sociales</option>
                            <option value="Email Campaign" {{ old('Source') == 'Email Campaign' ? 'selected' : '' }}>Campaña Email</option>
                            <option value="Cold Call" {{ old('Source') == 'Cold Call' ? 'selected' : '' }}>Llamada en Frío</option>
