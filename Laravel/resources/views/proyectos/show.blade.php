...
<style>
    .project-header {
        @apply bg-gradient-to-r from-indigo-600 to-blue-500 rounded-lg shadow-md p-6 text-white mb-6;
    }
    ...
    .action-button {
        @apply inline-flex items-center px-4 py-2 rounded-md shadow-sm text-sm font-medium focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500;
    }
...
<div class="max-w-7xl mx-auto">
    ...
    <div class="project-header flex flex-col md:flex-row justify-between">
        <div>
            ...
            @if($client)
                <p class="text-blue-100 mb-1">Cliente: {{ $client->Name }}</p>
            @endif
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div>
                <div class="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
                    ...
                    <div class="p-4">
                        <div class="mb-4">
                            <h4 class="text-sm font-medium text-gray-500 mb-1">Presupuesto</h4>
                        ...
                        <div>
                            <h4 class="text-sm font-medium text-gray-500 mb-1">Tipo de Facturación</h4>
    ...
    <div id="tab-notes" class="tab-content hidden">
                ...
                @foreach($notes as $note)
                    <div class="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
                        ...
                        <div class="px-4 py-3 bg-gray-50 border-t border-gray-200 flex justify-end space-x-2">
                            <a href="{{ route('notes.edit', $note->idNote) }}" class="text-indigo-600 hover:text-indigo-900 text-sm font-medium">
                                Editar
                            </a>
        ...
        @else
            <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6 text-center">
                ...
                <h3 class="text-lg font-medium text-gray-800 mb-1">No hay notas para este proyecto</h3>
                <p class="text-gray-500 mb-4">Crea la primera nota para llevar un seguimiento del proyecto.</p>
                <a href="{{ route('notes.create', ['related_to' => 'project', 'related_id' => $project->idProject]) }}" class="action-button btn-primary">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" viewBox="0 0 20 20" fill="currentColor">
                        <path fill-rule="evenodd" d="M10 3a1 1 0 011 1v5h5a1 1 0 110 2h-5v5a1 1 0 11-2 0v-5H4a1 1 0 110-2h5V4a1 1 0 011-1z" clip-rule="evenodd" />
                    </svg>
