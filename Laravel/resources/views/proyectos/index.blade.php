    ...
    <div class="bg-white rounded-lg shadow-sm p-6 mb-6">
        <div class="flex flex-col md:flex-row md:items-center md:justify-between">
            ...
            <div class="flex flex-col md:flex-row md:space-x-4 space-y-2 md:space-y-0">
                <a href="{{ route('proyectos.create') }}" class="btn-primary flex items-center justify-center">
        ...
        <div class="mt-4 border-t border-gray-200 pt-4">
            <form action="{{ route('proyectos.index') }}" method="GET" class="grid grid-cols-1 md:grid-cols-4 gap-4">
                <div>
                ...
                <div class="flex items-end">
                    <button type="submit" class="btn-primary bg-indigo-600 hover:bg-indigo-700 w-full">
    ...
    <div class="bg-white rounded-lg shadow-sm overflow-hidden">
        ...
        @else
            <div class="p-6 text-center">
                ...
                <h3 class="text-lg font-medium text-gray-800 mb-1">No hay proyectos disponibles</h3>
                <p class="text-gray-500">No se encontraron proyectos con los filtros aplicados.</p>
                <div class="mt-4">
                    <a href="{{ route('proyectos.create') }}" class="btn-primary bg-indigo-600 hover:bg-indigo-700 inline-flex items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6" />
                        </svg>
