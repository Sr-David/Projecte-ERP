...
<div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div class="flex items-center mb-10">
        ...
        <div>
            ...
            <p class="text-gray-500 mt-1">Completa la información para registrar un nuevo proyecto.</p>
        </div>
    </div>

    <!-- Formulario -->
    <form action="{{ route('proyectos.store') }}" method="POST" class="space-y-10">
        @csrf
        ...
        <div class="space-y-6">
            ...
            <div class="space-y-5">
                <div>
                    ...
                    <input type="text" name="Name" id="Name" value="{{ old('Name') }}" required class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:ring-indigo-500 focus:border-indigo-500">
                    @error('Name') <p class="text-sm text-red-600 mt-1">{{ $message }}</p> @enderror
                </div>

                <div>
                    <label for="Description" class="block text-sm font-medium text-gray-700">Descripción</label>
                    <textarea name="Description" id="Description" rows="4" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:ring-indigo-500 focus:border-indigo-500">{{ old('Description') }}</textarea>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="date" name="StartDate" id="StartDate" value="{{ old('StartDate') }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:ring-indigo-500 focus:border-indigo-500">
                    ...
                    <div>
                        ...
                        <input type="date" name="EndDate" id="EndDate" value="{{ old('EndDate') }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:ring-indigo-500 focus:border-indigo-500">
        ...
        <div class="space-y-6">
            ...
            <div class="space-y-5">
                <div>
                    ...
                    <input type="number" step="0.01" min="0" name="Budget" id="Budget" value="{{ old('Budget') }}" placeholder="0.00" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:ring-indigo-500 focus:border-indigo-500">
        ...
        <div class="space-y-6">
            ...
            <div>
                ...
                <textarea name="Notes" id="Notes" rows="3" placeholder="Información adicional sobre el proyecto..." class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:ring-indigo-500 focus:border-indigo-500">{{ old('Notes') }}</textarea>
        ...
        <div class="flex justify-end gap-4 pt-8 border-t border-gray-200">
            <a href="{{ route('proyectos.index') }}" class="inline-flex items-center px-4 py-2 border rounded-md text-gray-700 bg-white hover:bg-gray-50">
                Cancelar
            </a>
