    ...
    <div class="min-h-screen flex flex-col relative z-10">
        ...
        <header class="w-full py-4 px-6 md:px-12 flex justify-between items-center">
            <div class="flex items-center">
                <img src="/images/logoElevate.png" alt="Elevate CRM Logo" class="h-10 md:h-12 object-contain mr-3">
                <span class="text-xl font-semibold text-brand-dark">Elevate CRM</span>
            </div>
        ...
        <main class="flex-grow flex flex-col">
            ...
            <section class="pt-12 md:pt-20 pb-24 px-6 md:px-12 flex flex-col md:flex-row items-center justify-between max-w-7xl mx-auto">
                <div class="md:w-1/2 mb-12 md:mb-0 animate-slide-right">
                    <h1 class="text-4xl md:text-5xl font-bold text-brand-dark mb-6">
                        Gestiona tu negocio de forma <span class="text-brand-blue">inteligente</span>
                    </h1>
                    ...
                    <div class="flex flex-wrap gap-4">
                        <a href="{{ url('/login') }}" class="px-6 py-3 rounded-full bg-brand-blue text-white font-medium hover:shadow-lg button-effect relative overflow-hidden">
                            <span class="relative z-10">Comenzar ahora</span>
                        </a>
                        <a href="#features" class="px-6 py-3 rounded-full border border-gray-300 text-gray-700 font-medium hover:border-brand-blue hover:text-brand-blue transition-all">
                            Explorar funciones
                        </a>
                    </div>
                </div>
                <div class="md:w-1/2 flex justify-center md:justify-end animate-slide-left">
                    <img src="/images/placeholder.svg" alt="Elevate CRM Dashboard" class="w-full max-w-lg rounded-lg shadow-soft-xl">
                </div>
            </section>
            ...
            <section class="py-20 px-6 md:px-12 relative overflow-hidden">
                ...
                <div class="max-w-5xl mx-auto relative z-10 text-center">
                    <h2 class="text-3xl md:text-4xl font-bold text-brand-dark mb-6">Comienza a elevar tu negocio hoy</h2>
                    ...
                    <div class="flex flex-wrap justify-center gap-4">
                        <a href="{{ url('/login') }}" class="px-8 py-4 rounded-full bg-brand-blue text-white font-medium hover:shadow-lg button-effect relative overflow-hidden">
                            <span class="relative z-10">Crear cuenta gratis</span>
                        </a>
                        <a href="{{ url('/login') }}" class="px-8 py-4 rounded-full border border-gray-300 text-gray-700 font-medium hover:border-brand-blue hover:text-brand-blue transition-all">
                            Iniciar sesión
                        </a>
                    </div>
                </div>
        ...
        <footer class="bg-gray-50 py-12 px-6 md:px-12">
            <div class="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
                <div class="md:col-span-1">
                    <img src="/images/logoElevate.png" alt="Elevate CRM Logo" class="h-10 object-contain mb-4">
